...
import { Plus, Search, MoreVertical, Edit, Trash2, Eye, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function VendorProductsPage() {
  ...
  const { data: productsResponse, isLoading } = useQuery({
    queryKey: ['vendor-products', searchQuery, statusFilter, currentPage],
    queryFn: async () => {
      const result = await apiClient.get<ProductsResponse>('/vendor/products', {
        search: searchQuery,
